...
/*
  ...
  Weitere Optionen:
  -----------------
  Standardm‰ﬂig wird innerhalb des Dumps ein Unix Zeilenumbruch verwendet, mˆchte
  ...
  Datenbank befindlichen Tabellen, mˆchte man nur eine einzelne oder nur bestimmte
  ...
  Changelog
  ==============
  Von Version 2.0.1 auf Version 2.0.2 wurden folgende ƒnderungen vorgenommen:
  - in Zeile 272 und 273 (bzw. 284 und 285 in Version 2.0.1) fehlte ein abschlieﬂendes 
...
class MySQLDBExport {
  ...
  function escape_table_name($table) {
    // Escapen von Tabellen oder Datenbanknamen gem‰ﬂ
